...
;(function (globalObj) {
    ...
    */
    ...
    function constructorFactory(configObj) {
         ...
         *
         * n is a BigNumber.
         * i is the index.js of the last digit required (i.e. the digit that may be rounded up).
        ...
        function round( x, sd, rm, r ) {
            ...
            if (xc) {
                ...
                // ni is the index.js of n within x.c.
                // d is the number of digits of n.
                // i is the index.js of rd within n including leading zeros.
                // j is the actual index.js of rd within n (if < 0, rd is a leading zero).
                out: {
                    ...
                    if ( i < 0 ) {
                        ...
                        // Get the rounding digit at index.js j of n.
                        ...
                        if ( ni >= xc.length ) {
                            ...
                            // Get the index.js of rd within n.
                            i %= LOG_BASE;

                            // Get the index.js of rd within n, adjusted for leading zeros.
